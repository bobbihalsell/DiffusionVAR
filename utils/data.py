...
This module provides dataset classes and preprocessing functions for VAR and
DiffusionVAR training, including image normalization and augmentation.
...
def build_dataset(data_path: str, final_reso: int, hflip=False, mid_reso=1.125):
    """Build dataset with train/val splits and augmentations."""
    # build augmentations

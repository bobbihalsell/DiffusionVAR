"""
Distributed data samplers for training.

This module provides distributed sampling utilities for VAR and DiffusionVAR
training, including infinite batch sampling and evaluation samplers.

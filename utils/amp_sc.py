"""
Automatic Mixed Precision (AMP) optimizer wrapper.

This module provides AMP optimization support for training VAR and DiffusionVAR models
with automatic scaling and gradient clipping.
...
class AmpOptimizer:
    ...
    def backward_clip_step(
        ...
        # print(f"orig_norm: {orig_norm}, scaler_sc: {scaler_sc}") TODO

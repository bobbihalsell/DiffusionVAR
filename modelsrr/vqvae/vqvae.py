"""
VQVAE (Vector Quantized Variational AutoEncoder) implementation.

This module provides the VQVAE architecture used for image tokenization in VAR models,
...
class VQVAE(nn.Module):
    def __init__(
        ...
        ddconfig = dict(
            ...
            in_channels=3, ch_mult=(1, 1, 2, 2, 4), num_res_blocks=2,   # was ch_mult=(1, 1, 2, 2, 4), # from vq-f16/config.yaml above

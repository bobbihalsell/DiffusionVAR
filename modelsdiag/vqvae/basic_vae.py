"""
Basic VAE modules for VQVAE models.

This module provides the basic VAE modules used for image tokenization in VAR models,
including encoder, decoder, and quantization components for discrete representation learning.

References:
- VAR: https://github.com/FoundationVision/VAR
- VAE: https://github.com/CompVis/stable-diffusion/blob/21f890f9da3cfbeaba8e2ac3c425ee9e998d5229/ldm/modules/diffusionmodules/model.py
